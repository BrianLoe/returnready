...
4. Show deductions and disposals appearing in the UI with documentary provenance and Agent audit entries.
...
7. Generate the review pack. Point out the visible deduction-amount and crypto-fee warnings and the no-lodgement disclaimer.
8. Reset the demo.
